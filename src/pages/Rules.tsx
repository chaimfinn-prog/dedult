    ...
    <div className="space-y-4 animate-fade-up pb-4">
      ...
      <Section title="🗺️ ניקוד הלוח־עץ (שלבים)">
        ...
        <ul className="mt-2 space-y-1.5">
          <li>
            🏟️ <b>מיקומי בתים</b> — רק <b>2 העולות</b> (מקום 1–2): <b>5</b> נק'
            למיקום מדויק, <b>2</b> נק' אם הקבוצה עלתה אבל ניחשת אותה במקום העולה
            השני. מקומות 3–4 לא מזכים. מקסימום <b>10</b> לבית.
          </li>
          <li>
