    ...
    <div className="space-y-4 animate-fade-up pb-4">
      ...
      <Section title="🗺️ ניקוד הלוח־עץ (שלבים)">
        ...
        <ul className="mt-2 space-y-1.5">
          ...
          <li>
            🏆 <b>התקדמות בנוקאאוט</b> — סכום כולל (לא מצטבר) לפי כמה רחוק הגיעה
            הקבוצה שניחשת: <b>20</b> נק' על הגעה לשמינית הגמר (R16), <b>30</b> נק'
            על הגעה לרבע הגמר — קרדיט חלקי אם הניחוש לא הגיע כל כך רחוק. חצי גמר/
            גמר/זכייה כבר מכוסים ע"י בונוס האלוף+סגנית, ולכן לא מנוקדים כאן בנפרד.
          </li>
        </ul>
        <p className="mt-2 text-grass-500">
