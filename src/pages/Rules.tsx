    ...
    <div className="space-y-4 animate-fade-up pb-4">
      ...
      <Section title="✍️ מה צריך לנחש">
        ...
        <p className="mt-2 text-grass-500">
          ...
          משחק פתוח עד ממש שריקת הפתיחה של אותו משחק. אחרי הנעילה אי אפשר לשנות.
        </p>
      </Section>
      ...
      <Section title="⚽ ניחוש משחק — לפי יחסי אתר ההימורים">
        ...
        <p className="mt-2">
          ⚡ <b>מכפיל נוקאאוט עולה לפי שלב</b> — משחקי הנוקאאוט מקבלים מכפיל
          שעולה ככל שהטורניר מתקדם, על ניקוד הכיוון + הבינגו: R32{" "}
          <b className="text-accent-600">×1.25</b> · שמינית גמר{" "}
          <b className="text-accent-600">×1.35</b> · רבע גמר{" "}
          <b className="text-accent-600">×1.4</b> · חצי גמר{" "}
          <b className="text-accent-600">×1.45</b> · גמר{" "}
          <b className="text-accent-600">×1.5</b>. המשחקים חשובים יותר, הניקוד גבוה יותר.
        </p>
      </Section>
      ...
      <Section title="🎯 בונוס אלוף + סגנית">
        ...
        <p className="mt-2">
          🔄 <b>זיהית נכון את שתי הגמריסטיות אך בסדר הפוך?</b> (מי שסימנת כאלוף
          הפסידה, ומי שסימנת כסגנית ניצחה) — עדיין מקבלים קרדיט: נקודות ברמת
          "סגנית" (המשקל הנמוך) לכל אחת מהשתיים, בלי בונוס הכפול — פחות מקליעה
          מדויקת, אבל הרבה יותר מטעות מוחלטת.
        </p>
      </Section>
      ...
      <Section title="🗺️ ניקוד הלוח־עץ (שלבים)">
        ...
        <ul className="mt-2 space-y-1.5">
          ...
          <li>
            🏆 <b>התקדמות בנוקאאוט</b> — כל שלב שהקבוצה עוברת מוסיף עוד נקודות
            (מצטבר): <b>10</b> נק' על מעבר לשמינית הגמר (R16), עוד <b>20</b> על
            מעבר לרבע הגמר (סה"כ <b>30</b>), ועוד <b>30</b> על מעבר לחצי הגמר
            (סה"כ <b>60</b>) — קרדיט חלקי אם הניחוש לא הגיע כל כך רחוק. הגעה
            לגמר/זכייה לא מוסיפה מעבר לזה, כי זה כבר מכוסה ע"י בונוס האלוף+סגנית.
          </li>
        </ul>
        <p className="mt-2 text-grass-500">
