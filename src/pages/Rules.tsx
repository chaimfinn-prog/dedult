    ...
    <div className="space-y-4 animate-fade-up pb-4">
      ...
      <Section title="🗺️ ניקוד הלוח־עץ">
        ...
        <ul className="mt-2 space-y-1.5">
          <li>
            🏟️ <b>מיקומים בבתים</b> — <b>5</b> נק' לכל קבוצה שניחשת ב<b>מיקום
            המדויק</b> (מקום 1, 2 או 3) — מקסימום <b>15</b> לבית.
          </li>
          <li>
        ...
        <p className="mt-2 text-grass-500">
          סך הכל הלוח־עץ שווה כ-<b>180</b> נק' מהבתים ועוד <b>~300</b> מהנוקאאוט —
